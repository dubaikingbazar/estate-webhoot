...
app.post('/api/chat/:brokerId', async (req, res) => {
  ...
  try {
    ...
    const fallbackMsg = isRateLimited
      ? 'Ek second, thoda busy hai system — turant phir try karein 🙏'
      : 'Kuch gadbad ho gayi, dobara try karein.';

    let reply = data.choices?.[0]?.message?.content || fallbackMsg;
...
.chat-wrap{width:100%;max-width:480px;background:#F7F4ED;display:flex;flex-direction:column;position:relative;overflow:hidden;}
...
.powered{width:100%;max-width:480px;background:#F7F4ED;border-top:1px solid #EDE7D8;padding:13px;display:flex;align-items:center;justify-content:center;gap:6px;font-size:10px;color:#6B6354;font-weight:700;}
...
<div class="chat-wrap">
  <div class="chat-wrap-inner">
    <svg class="skyline-wm" viewBox="0 0 400 140" preserveAspectRatio="xMidYMax slice">
      ...
      <line x1="52" y1="84" x2="52" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="58" y1="84" x2="58" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="64" y1="84" x2="64" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="82" y="38" width="30" height="102" fill="#C9A35E"/>
      <polygon points="97,18 91,38 103,38" fill="#C9A35E"/>
      <line x1="97" y1="6" x2="97" y2="18" stroke="#0E1B30" stroke-width="2"/>
      <line x1="88" y1="44" x2="88" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="94" y1="44" x2="94" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="100" y1="44" x2="100" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="106" y1="44" x2="106" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="118" y="64" width="24" height="76" fill="#C9A35E"/>
      <line x1="124" y1="70" x2="124" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="130" y1="70" x2="130" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="136" y1="70" x2="136" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      ...
      <line x1="186" y1="56" x2="186" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="192" y1="56" x2="192" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="198" y1="56" x2="198" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="206" y="72" width="28" height="68" fill="#C9A35E"/>
      <line x1="212" y1="78" x2="212" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="219" y1="78" x2="219" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="226" y1="78" x2="226" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="238" y="44" width="26" height="96" fill="#C9A35E"/>
      <rect x="246" y="34" width="10" height="12" fill="#C9A35E"/>
      <line x1="244" y1="50" x2="244" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="250" y1="50" x2="250" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="256" y1="50" x2="256" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="268" y="92" width="24" height="48" fill="#C9A35E"/>
      <line x1="274" y1="98" x2="274" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="280" y1="98" x2="280" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="286" y1="98" x2="286" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="296" y="56" width="24" height="84" fill="#C9A35E"/>
      <line x1="308" y1="40" x2="308" y2="56" stroke="#0E1B30" stroke-width="2"/>
      <circle cx="308" cy="38" r="1.6" fill="#C9A35E"/>
      <line x1="302" y1="62" x2="302" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="308" y1="62" x2="308" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="314" y1="62" x2="314" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <rect x="324" y="74" width="30" height="66" fill="#C9A35E"/>
      <line x1="331" y1="80" x2="331" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="338" y1="80" x2="338" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
      <line x1="345" y1="80" x2="345" y2="136" stroke="#F7F4ED" stroke-width=".6" opacity=".5"/>
    </svg>
