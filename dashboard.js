...
function renderAnalytics(){
  ...
  const today=new Date().toDateString();
  const todayLeads=allLeads.filter(l=>new Date(l.created_at).toDateString()===today);
  document.getElementById('analyticsStats').innerHTML=`<div style="background:#fff;border:1px solid var(--border);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${allLeads.length}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Total Leads</div></div><div style="background:#fff;border:1px solid var(--border);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#4ade80;">${converted}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Converted</div></div><div style="background:#fff;border:1px solid var(--border);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${convRate}%</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Conversion Rate</div></div><div style="background:#fff;border:1px solid var(--border);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#7C3AED;">${todayLeads.length}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Today's Leads</div></div>`;
  const days=[],counts=[];
