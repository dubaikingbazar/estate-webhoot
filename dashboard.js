...
function getScoreColor(t){return t==='hot'?'#EF4444':t==='warm'?'#FB923C':'#60A5FA';}
...
async function initDashboard(brokerId){
  ...
  if (broker.status === 'active' && broker.subscription_valid_till) {
    ...
    planText = '✅ Active' + (activeSince !== null ? ' · ' + activeSince + ' days active' : '') + '\n⏳ ' + daysLeft + ' days left';
    ...
    planText = '❌ Expired — Please subscribe';
  } else {
...
function getScoreBadge(scoreType){
  if(scoreType==='hot') return `<div style="display:inline-flex;align-items:center;gap:4px;border:1px solid rgba(239,68,68,0.4);border-radius:20px;padding:3px 8px 3px 6px;background:rgba(239,68,68,0.04);animation:hotPulse 2.5s ease-in-out infinite;"><svg width="11" height="15" viewBox="0 0 20 28" fill="none" style="animation:flameWave 1.4s ease-in-out infinite alternate;display:block;flex-shrink:0;"><path d="M10 1C10 1 15 6 14 11C14 11 17 8.5 16.5 6.5C19 9.5 19.5 15 17 18.5C18.5 17 18.8 15.5 18.5 14C20 16.5 19.5 22 16.5 25C14.5 27 12 27.5 10 27.5C8 27.5 5.5 27 3.5 25C0.5 22 0 16.5 1.5 14C1.2 15.5 1.5 17 3 18.5C0.5 15 1 9.5 3.5 6.5C3 8.5 6 11 6 11C5 6 10 1 10 1Z" stroke="#EF4444" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 10C10 10 12.5 13.5 12 16.5C13.5 15 13.2 13.8 13.2 13.8C14.5 15.5 14.2 18.5 13 20.5C13.8 19.8 14 18.8 13.8 18C14.8 19.5 14.2 22.5 12.5 23.8C11.5 24.5 8.5 24.5 7.5 23.8C5.8 22.5 5.2 19.5 6.2 18C6 18.8 6.2 19.8 7 20.5C5.8 18.5 5.5 15.5 6.8 13.8C6.5 15 8 16.5 8 16.5C7.5 13.5 10 10 10 10Z" stroke="#EF4444" stroke-width="0.9" stroke-linecap="round" stroke-linejoin="round" opacity="0.6"/></svg><span style="font-size:8px;font-weight:900;letter-spacing:1.5px;color:#EF4444;">HOT</span></div>`;
  if(scoreType==='warm') return `<div style="display:inline-flex;align-items:center;gap:4px;border:1px solid rgba(251,146,60,0.3);border-radius:20px;padding:3px 8px 3px 6px;background:rgba(251,146,60,0.04);animation:warmPulse 3.5s ease-in-out infinite;"><svg width="11" height="11" viewBox="0 0 20 20" fill="none" style="animation:sunPulse 3s ease-in-out infinite;display:block;flex-shrink:0;"><circle cx="10" cy="10" r="4" stroke="#FB923C" stroke-width="1.3" fill="none"/><line x1="10" y1="1" x2="10" y2="3.5" stroke="#FB923C" stroke-width="1.2" stroke-linecap="round"/><line x1="10" y1="16.5" x2="10" y2="19" stroke="#FB923C" stroke-width="1.2" stroke-linecap="round"/><line x1="1" y1="10" x2="3.5" y2="10" stroke="#FB923C" stroke-width="1.2" stroke-linecap="round"/><line x1="16.5" y1="10" x2="19" y2="10" stroke="#FB923C" stroke-width="1.2" stroke-linecap="round"/><line x1="3.5" y1="3.5" x2="5.3" y2="5.3" stroke="#FB923C" stroke-width="1" stroke-linecap="round" opacity="0.6"/><line x1="14.7" y1="14.7" x2="16.5" y2="16.5" stroke="#FB923C" stroke-width="1" stroke-linecap="round" opacity="0.6"/><line x1="16.5" y1="3.5" x2="14.7" y2="5.3" stroke="#FB923C" stroke-width="1" stroke-linecap="round" opacity="0.6"/><line x1="5.3" y1="14.7" x2="3.5" y2="16.5" stroke="#FB923C" stroke-width="1" stroke-linecap="round" opacity="0.6"/></svg><span style="font-size:8px;font-weight:800;letter-spacing:1.5px;color:#FB923C;">WARM</span></div>`;
  return `<div style="display:inline-flex;align-items:center;gap:4px;border:1px solid rgba(96,165,250,0.2);border-radius:20px;padding:3px 8px 3px 6px;background:rgba(96,165,250,0.03);animation:coldPulse 5s ease-in-out infinite;"><svg width="11" height="11" viewBox="0 0 20 20" fill="none" style="animation:snowSpin 5s linear infinite;display:block;flex-shrink:0;"><line x1="10" y1="1" x2="10" y2="19" stroke="#60A5FA" stroke-width="1.5" stroke-linecap="round"/><line x1="1" y1="10" x2="19" y2="10" stroke="#60A5FA" stroke-width="1.5" stroke-linecap="round"/><line x1="3" y1="3" x2="17" y2="17" stroke="#60A5FA" stroke-width="1" stroke-linecap="round" opacity="0.5"/><line x1="17" y1="3" x2="3" y2="17" stroke="#60A5FA" stroke-width="1" stroke-linecap="round" opacity="0.5"/><circle cx="10" cy="10" r="2" stroke="#60A5FA" stroke-width="1.2" fill="none"/><line x1="10" y1="1" x2="7.5" y2="4" stroke="#60A5FA" stroke-width="1" stroke-linecap="round" opacity="0.6"/><line x1="10" y1="1" x2="12.5" y2="4" stroke="#60A5FA" stroke-width="1" stroke-linecap="round" opacity="0.6"/><line x1="10" y1="19" x2="7.5" y2="16" stroke="#60A5FA" stroke-width="1" stroke-linecap="round" opacity="0.6"/><line x1="10" y1="19" x2="12.5" y2="16" stroke="#60A5FA" stroke-width="1" stroke-linecap="round" opacity="0.6"/></svg><span style="font-size:8px;font-weight:800;letter-spacing:1.5px;color:#60A5FA;opacity:0.6;">COLD</span></div>`;
}

function buildLeadRow(lead){
  leadStore[lead.id] = lead;
  const score=lead.score,scoreType=lead.scoreType;
  const av=getInitials(lead.name);
  ...
  const accentColor = scoreType==='hot'?'rgba(239,68,68,0.45)':scoreType==='warm'?'rgba(251,146,60,0.25)':'rgba(96,165,250,0.12)';
  return `<div class="lead-row${lead.isDuplicate?' duplicate':''}" onclick="openDetail('${lead.id}')" style="border-left:2px solid ${accentColor};">
    <div style="min-width:52px;flex-shrink:0;">${getScoreBadge(scoreType)}</div>
...
function renderTable(){
  ...
  if(!total){document.getElementById('leadsBody').innerHTML='<div class="empty-state"><h3>No leads found</h3><p>Try changing the filter or share your bot link</p></div>';document.getElementById('paginationWrap').style.display='none';return;}
...
function renderTable2(){
  ...
  if(!total){document.getElementById('leadsBody2').innerHTML='<div class="empty-state"><h3>No leads found</h3><p>Try changing the filter</p></div>';document.getElementById('paginationWrap2').style.display='none';return;}
...
function openDetail(leadId){
  ...
  document.getElementById('detailBody').innerHTML=`
    <div style="margin-bottom:12px;">${getScoreBadge(scoreType)}</div>
    <div class="detail-top">
      ...
      <div class="score-wrap"><div class="score-num" style="color:${scoreColor};">${score}%</div><div class="score-lbl">Score</div><div class="score-bar" style="width:50px;margin-top:4px;"><div class="score-bar-fill" style="width:${score}%;background:${scoreColor};opacity:0.5;"></div></div></div>
    </div>
    ...
    <div class="detail-section">
      ...
      <div style="margin-bottom:6px;"><div class="score-bar"><div class="score-bar-fill" style="width:${score}%;background:${scoreColor};opacity:0.4;"></div></div></div>
    ...
    <div class="detail-section">
      ...
      <div id="callLogDisplay_${lead.id}" style="margin-bottom:8px;">${logs.length?logs.slice(-3).map(l=>`<div style="font-size:11px;color:var(--muted);padding:4px 0;border-bottom:1px solid rgba(232,224,208,0.05);">${l}</div>`).join(''):'<div style="font-size:12px;color:var(--muted);">No calls logged yet</div>'}</div>
...
function logCall(leadId,leadName){const now=new Date().toLocaleString('en-IN',{day:'numeric',month:'short',hour:'2-digit',minute:'2-digit'});const result=prompt('Enter call result');if(result===null)return;if(!callLogs[leadId])callLogs[leadId]=[];callLogs[leadId].push(`📞 ${now} — ${result||'Called'}`);localStorage.setItem('eb_calllogs',JSON.stringify(callLogs));const el=document.getElementById('callLogDisplay_'+leadId);if(el)el.innerHTML=callLogs[leadId].slice(-3).map(l=>`<div style="font-size:11px;color:var(--muted);padding:4px 0;border-bottom:1px solid rgba(232,224,208,0.05);">${l}</div>`).join('');showToast('Call logged!');}
...
function renderAnalytics(){
  ...
  const today=new Date().toDateString();
  const todayLeads=allLeads.filter(l=>new Date(l.created_at).toDateString()===today);
  document.getElementById('analyticsStats').innerHTML=`<div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${allLeads.length}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Total Leads</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#4ade80;">${converted}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Converted</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${convRate}%</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Conversion Rate</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;"><div style="font-size:20px;font-weight:800;color:#7C3AED;">${todayLeads.length}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Today's Leads</div></div>`;
  const days=[],counts=[];
  ...
  document.getElementById('chartLeadsDay').innerHTML=counts.map(c=>`<div class="bar-wrap"><div class="bar" style="background:#E8E0D0;height:${Math.max((c/maxC)*95,4)}px;" title="${c}"></div></div>`).join('');
...
function renderFollowUps(){
  ...
  if(!upcoming.length&&!done.length){document.getElementById('followUpsContainer').innerHTML=`<div style="text-align:center;padding:48px;color:var(--muted);"><div style="font-size:32px;margin-bottom:12px;">⏰</div><div style="font-size:15px;font-weight:600;color:var(--text);margin-bottom:6px;">No follow-ups yet</div></div>`;return;}
  let html='';
...
function openAddFollowUp(leadId,leadName){
  ...
  sel.innerHTML='<option value="">-- Select Lead --</option>'+allLeads.map(l=>`<option value="${l.id}|${l.name}" ${l.id===leadId?'selected':''}>${l.name} — ${l.phone||''}</option>`).join('');
...
function saveFollowUp(){
  ...
  if(!sel||!date){showToast('Please select a lead and date','error');return;}
  ...
  closeFuModal();renderFollowUps();showToast('Follow-up scheduled!');
}
...
function renderSettings(){
  ...
  document.getElementById('settingsAccountInfo').innerHTML=`<div style="display:flex;flex-direction:column;gap:8px;">${[['Name',currentBroker.name],['Email',currentBroker.email||'—'],['Phone',currentBroker.phone||'—'],['City',currentBroker.city||'—'],['Plan',currentBroker.status?.toUpperCase()]].map(([k,v])=>`<div style="display:flex;justify-content:space-between;padding:7px 0;border-bottom:1px solid rgba(232,224,208,0.07);font-size:12px;"><span style="color:var(--muted);">${k}</span><span style="font-weight:600;">${v}</span></div>`).join('')}</div>`;
...
async function changePassword(){
  ...
  if(!p1||!p2){showToast('Please fill in both password fields','error');return;}
  ...
  if(ok){showToast('Password updated successfully! ✅');document.getElementById('newPass1').value='';document.getElementById('newPass2').value='';}
  else showToast('Update failed','error');
}

function copyBotLink(){if(!currentBroker)return;navigator.clipboard.writeText('https://estatebotai.in/'+currentBroker.broker_id);showToast('Link copied! 📋');}
...
function setupLeadPolling(brokerId){
  ...
  setInterval(async()=>{
    ...
    if(data&&data[0]&&allLeads.length>0){const latestId=data[0].id;const found=allLeads.find(l=>l.id===latestId);if(!found){const lead=data[0];if(Notification.permission==='granted'){new Notification('🔥 New Lead!',{body:`${lead.name||'New lead'} — ${lead.phone||''}`,icon:'/favicon.ico'});}showToast('🔥 New lead received — '+(lead.name||'Unknown'));await loadLeads(brokerId);}}
  },30000);
}
...
function switchLeadsTab(tab){
  currentLeadsTab=tab;
  document.getElementById('tab-active').style.background=tab==='active'?'#E8E0D0':'transparent';
  document.getElementById('tab-active').style.color=tab==='active'?'#080808':'#3d3830';
  document.getElementById('tab-archived').style.background=tab==='archived'?'#E8E0D0':'transparent';
  document.getElementById('tab-archived').style.color=tab==='archived'?'#080808':'#3d3830';
...
function renderArchivedLeads(){
  ...
  if(!archived.length){body.innerHTML='<div class="empty-state"><h3>No archived leads</h3></div>';wrap.style.display='none';return;}
  body.innerHTML=archived.map(lead=>{
    const score=lead.score||getScore(lead);const scoreType=lead.scoreType||getScoreType(score);
    const av=getInitials(lead.name);
    const intentShort=(lead.intent||'').replace(' Chahte Hain','').replace(' Chahte Hai','');
    return `<div class="lead-row" style="opacity:0.6;"><div style="min-width:52px;flex-shrink:0;">${getScoreBadge(scoreType)}</div><div class="lead-av" style="background:rgba(232,224,208,0.06);border:1px solid rgba(232,224,208,0.1);color:#E8E0D0;">${av}</div><div class="lead-main-info"><div class="lead-name">${lead.name||'—'} <span style="font-size:9px;background:rgba(232,224,208,0.08);color:#8a7f70;padding:2px 6px;border-radius:4px;font-weight:600;">ARCHIVED</span></div><div class="lead-sub">${lead.phone||'—'}</div><div class="lead-sub">${intentShort} · ${lead.property_type||'—'}</div></div><div class="lead-right"><div class="lead-budget-val">${lead.budget||'—'}</div><div class="lead-score-val">${score}%</div></div><button onclick="unarchiveLead('${lead.id}')" style="background:rgba(16,185,129,0.1);color:#10B981;border:1px solid rgba(16,185,129,0.2);padding:5px 10px;border-radius:7px;font-size:11px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;flex-shrink:0;">Restore</button></div>`;
  }).join('');
...
function unarchiveLead(leadId){
  ...
  showToast('Lead restored!');renderArchivedLeads();
}
...
function renderTagsSection(leadId){
  ...
  return `<div class="detail-section"><div class="detail-section-title">Tags</div><div style="display:flex;flex-wrap:wrap;gap:5px;margin-bottom:8px;" id="tagDisplay_${leadId}">${currentTags.length?currentTags.map(t=>`<span style="background:rgba(232,224,208,0.08);color:#8a7f70;padding:3px 9px;border-radius:100px;font-size:11px;font-weight:600;cursor:pointer;" onclick="removeTag('${leadId}','${t}')">${t} ×</span>`).join(''):'<span style="font-size:12px;color:var(--muted);">No tags yet</span>'}</div><select onchange="addTag('${leadId}',this.value);this.value='';" style="width:100%;border:1.5px solid rgba(232,224,208,0.1);border-radius:8px;padding:7px 10px;font-size:12px;font-family:'Inter',sans-serif;outline:none;color:#8a7f70;background:#0d0d0d;"><option value="">+ Add Tag</option>${TAG_OPTIONS.map(t=>`<option value="${t}">${t}</option>`).join('')}</select></div>`;
}
...
async function bulkUpdateStatus(status){
  if(!selectedLeads.size){showToast('Please select leads first','error');return;}
...
function showMonthlyReport(){
  ...
  document.getElementById('reportContent').innerHTML=`<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:16px;"><div style="background:#080808;border-radius:10px;padding:14px;text-align:center;"><div style="font-size:28px;font-weight:800;color:#E8E0D0;">${monthLeads.length}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Total Leads</div></div><div style="background:#080808;border-radius:10px;padding:14px;text-align:center;"><div style="font-size:28px;font-weight:800;color:#10B981;">${converted}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Converted</div></div><div style="background:#080808;border-radius:10px;padding:14px;text-align:center;"><div style="font-size:28px;font-weight:800;color:#EF4444;">${hot}</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Hot Leads</div></div><div style="background:#080808;border-radius:10px;padding:14px;text-align:center;"><div style="font-size:28px;font-weight:800;color:#E8E0D0;">${monthLeads.length?Math.round((converted/monthLeads.length)*100):0}%</div><div style="font-size:11px;color:#3d3830;margin-top:3px;">Conversion Rate</div></div></div><div style="background:#080808;border-radius:10px;padding:14px;margin-bottom:12px;"><div style="font-size:12px;font-weight:700;margin-bottom:8px;">📅 ${now.toLocaleString('en-IN',{month:'long',year:'numeric'})} Summary</div><div style="font-size:13px;line-height:1.8;">${bestDay?`🏆 Best day: <b>${bestDay[0]}</b> (${bestDay[1]} leads)<br>`:''}💰 Est. Commission: <b>₹${revEst.toLocaleString('en-IN')}</b><br>📊 Avg per day: <b>${(monthLeads.length/now.getDate()).toFixed(1)} leads</b></div></div><button onclick="exportMonthlyReport()" style="width:100%;background:#E8E0D0;color:#080808;border:none;padding:10px;border-radius:8px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;">📥 Download Report</button>`;
...
function checkDailySummary(){
  ...
  document.getElementById('summaryContent').innerHTML=`<div style="font-size:28px;margin-bottom:12px;">☀️</div><div style="font-size:18px;font-weight:800;color:#E8E0D0;margin-bottom:6px;">Good morning, ${currentBroker?.name?.split(' ')[0]||''}!</div><div style="font-size:13px;color:var(--muted);margin-bottom:20px;">Aaj ka summary</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:18px;"><div style="background:#0d0d0d;border:1px solid rgba(251,146,60,0.2);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:24px;font-weight:800;color:#FB923C;">${todayFUs.length}</div><div style="font-size:11px;color:#8a7f70;margin-top:3px;">Follow Ups Today</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.08);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:24px;font-weight:800;color:#E8E0D0;">${todayLeads.length}</div><div style="font-size:11px;color:#8a7f70;margin-top:3px;">New Leads Today</div></div></div>${todayFUs.length>0?`<div style="background:rgba(239,68,68,0.06);border:1px solid rgba(239,68,68,0.15);border-radius:8px;padding:10px 12px;margin-bottom:12px;font-size:12px;color:#EF4444;font-weight:600;">⚠️ ${todayFUs.length} follow up pending!</div>`:''}<button onclick="document.getElementById('summaryModal').classList.remove('show');showPage('followups');" style="width:100%;background:#E8E0D0;color:#080808;border:none;padding:10px;border-radius:8px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;margin-bottom:8px;">View Follow Ups</button><button onclick="document.getElementById('summaryModal').classList.remove('show');" style="width:100%;background:transparent;color:var(--muted);border:1px solid var(--border);padding:10px;border-radius:8px;font-size:13px;cursor:pointer;font-family:'Inter',sans-serif;">Dismiss</button>`;
...
function saveProperty(){const title=document.getElementById('propTitle').value.trim(),type=document.getElementById('propType').value,location=document.getElementById('propLocation').value.trim(),price=document.getElementById('propPrice').value.trim(),status=document.getElementById('propStatus').value,details=document.getElementById('propDetails').value.trim();if(!title||!location||!price){showToast('Title, location and price are required','error');return;}properties.push({id:Date.now().toString(),title,type,location,price,status,details,addedOn:new Date().toISOString()});localStorage.setItem('eb_properties',JSON.stringify(properties));document.getElementById('propModal').classList.remove('show');['propTitle','propLocation','propPrice','propDetails'].forEach(id=>document.getElementById(id).value='');renderProperties();showToast('Property added!');}
function renderProperties(){
  ...
  document.getElementById('propStats').innerHTML=`<div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${properties.length}</div><div style="font-size:11px;color:var(--muted);">Total</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#4ade80;">${properties.filter(p=>p.status==='available').length}</div><div style="font-size:11px;color:var(--muted);">Available</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${properties.filter(p=>p.status==='sold').length}</div><div style="font-size:11px;color:var(--muted);">Sold</div></div>`;
  if(!filtered.length){document.getElementById('propList').innerHTML='<div class="table-loading">No properties found — Add one!</div>';return;}
  const sc={available:'#10B981',sold:'#EF4444',rented:'#F59E0B'},sb={available:'rgba(16,185,129,0.1)',sold:'rgba(239,68,68,0.1)',rented:'rgba(245,158,11,0.1)'};
  document.getElementById('propList').innerHTML=filtered.map(p=>`<div style="display:flex;align-items:center;gap:12px;padding:12px 14px;border-bottom:1px solid rgba(232,224,208,0.07);"><div style="width:36px;height:36px;border-radius:9px;background:rgba(232,224,208,0.06);display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0;">${p.type==='flat'?'🏢':p.type==='house'?'🏠':p.type==='plot'?'🌍':'🏪'}</div><div style="flex:1;min-width:0;"><div style="font-size:13px;font-weight:600;">${p.title}</div><div style="font-size:11px;color:var(--muted);">📍 ${p.location} · ${p.type}${p.details?' · '+p.details:''}</div></div><div style="text-align:right;flex-shrink:0;"><div style="font-size:13px;font-weight:700;">₹${p.price}</div><span style="background:${sb[p.status]};color:${sc[p.status]};padding:2px 7px;border-radius:4px;font-size:9px;font-weight:700;">${p.status.toUpperCase()}</span></div><select onchange="updatePropStatus('${p.id}',this.value)" style="border:1px solid rgba(232,224,208,0.1);border-radius:7px;padding:5px 7px;font-size:11px;font-family:'Inter',sans-serif;outline:none;background:#0d0d0d;color:#8a7f70;"><option value="available" ${p.status==='available'?'selected':''}>Available</option><option value="sold" ${p.status==='sold'?'selected':''}>Sold</option><option value="rented" ${p.status==='rented'?'selected':''}>Rented</option></select><button onclick="if(confirm('Delete?')){properties=properties.filter(x=>x.id!=='${p.id}');localStorage.setItem('eb_properties',JSON.stringify(properties));renderProperties();showToast('Deleted!')}" style="background:none;border:none;color:#EF4444;cursor:pointer;font-size:14px;">🗑</button></div>`).join('');
}
...
function renderVisits(){
  ...
  const today=new Date().toDateString();
  document.getElementById('visitStats').innerHTML=`<div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${siteVisits.length}</div><div style="font-size:11px;color:var(--muted);">Total</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${siteVisits.filter(v=>new Date(v.date+'T00:00:00').toDateString()===today).length}</div><div style="font-size:11px;color:var(--muted);">Aaj</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${siteVisits.filter(v=>v.status==='scheduled').length}</div><div style="font-size:11px;color:var(--muted);">Scheduled</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#4ade80;">${siteVisits.filter(v=>v.status==='completed').length}</div><div style="font-size:11px;color:var(--muted);">Completed</div></div>`;
  if(!filtered.length){document.getElementById('visitList').innerHTML='<div class="table-loading">No visits yet</div>';return;}
  const sc={scheduled:'#5B3DF5',completed:'#10B981',cancelled:'#EF4444'},sb={scheduled:'rgba(91,61,245,0.1)',completed:'rgba(16,185,129,0.1)',cancelled:'rgba(239,68,68,0.1)'};
  document.getElementById('visitList').innerHTML=filtered.sort((a,b)=>a.date.localeCompare(b.date)).map(v=>`<div style="padding:12px 14px;border-bottom:1px solid rgba(232,224,208,0.07);"><div style="display:flex;align-items:flex-start;gap:10px;margin-bottom:8px;"><div style="flex:1;"><div style="font-size:13px;font-weight:600;">${v.leadName} <span style="background:${sb[v.status]};color:${sc[v.status]};padding:2px 7px;border-radius:4px;font-size:9px;font-weight:700;">${v.status.toUpperCase()}</span></div><div style="font-size:11px;color:var(--muted);">📞 ${v.leadPhone} · 🏠 ${v.property}</div><div style="font-size:11px;color:var(--muted);">📅 ${new Date(v.date+'T00:00:00').toLocaleDateString('en-IN',{day:'numeric',month:'short'})} ${v.time?'⏰ '+v.time:''}</div>${v.feedback?`<div style="font-size:11px;color:#10B981;">💬 ${v.feedback}</div>`:''}</div><button onclick="if(confirm('Delete?')){siteVisits=siteVisits.filter(x=>x.id!=='${v.id}');localStorage.setItem('eb_visits',JSON.stringify(siteVisits));renderVisits();}" style="background:none;border:none;color:#EF4444;cursor:pointer;font-size:13px;">🗑</button></div>${v.status==='scheduled'?`<div style="display:flex;gap:6px;"><button onclick="siteVisits=siteVisits.map(x=>x.id==='${v.id}'?{...x,status:'completed'}:x);localStorage.setItem('eb_visits',JSON.stringify(siteVisits));renderVisits();showToast('✅ Completed!')" style="background:rgba(16,185,129,0.1);color:#10B981;border:1px solid rgba(16,185,129,0.2);padding:5px 10px;border-radius:7px;font-size:11px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;">✓ Done</button><button onclick="const fb=prompt('Feedback:');if(fb){siteVisits=siteVisits.map(x=>x.id==='${v.id}'?{...x,feedback:fb}:x);localStorage.setItem('eb_visits',JSON.stringify(siteVisits));renderVisits();}" style="background:rgba(91,61,245,0.1);color:#5B3DF5;border:1px solid rgba(91,61,245,0.2);padding:5px 10px;border-radius:7px;font-size:11px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;">💬 Feedback</button><button onclick="siteVisits=siteVisits.map(x=>x.id==='${v.id}'?{...x,status:'cancelled'}:x);localStorage.setItem('eb_visits',JSON.stringify(siteVisits));renderVisits();" style="background:rgba(239,68,68,0.08);color:#EF4444;border:1px solid rgba(239,68,68,0.15);padding:5px 10px;border-radius:7px;font-size:11px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;">✕ Cancel</button></div>`:''}</div>`).join('');
}

let deals=JSON.parse(localStorage.getItem('eb_deals')||'[]');
function addDeal(){const client=document.getElementById('dealClient').value.trim(),property=document.getElementById('dealProperty').value.trim(),amount=document.getElementById('dealAmount').value.trim(),commPct=parseFloat(document.getElementById('dealCommission').value)||2,date=document.getElementById('dealDate').value||new Date().toISOString().split('T')[0];if(!client||!property||!amount){showToast('Client, property and amount are required','error');return;}const n=parseFloat(amount.replace(/[^0-9.]/g,''))||0;const amtRs=amount.toLowerCase().includes('lakh')||amount.toLowerCase().includes('lac')?n*100000:amount.toLowerCase().includes('cr')?n*10000000:n;const comm=Math.round(amtRs*(commPct/100));deals.push({id:Date.now().toString(),client,property,amount,amtRs,commPct,commission:comm,date});localStorage.setItem('eb_deals',JSON.stringify(deals));['dealClient','dealProperty','dealAmount','dealCommission'].forEach(id=>document.getElementById(id).value='');renderRevenue();showToast('Deal saved! 💰');}
...
function renderRevenue(){const now=new Date(),ms=new Date(now.getFullYear(),now.getMonth(),1);const md=deals.filter(d=>new Date(d.date)>=ms);const tc=deals.reduce((s,d)=>s+(d.commission||0),0),mc=md.reduce((s,d)=>s+(d.commission||0),0),target=parseInt(localStorage.getItem('eb_target'))||0;document.getElementById('revenueStats').innerHTML=`<div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${deals.length}</div><div style="font-size:11px;color:var(--muted);">Total Deals</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#4ade80;">₹${(tc/100000).toFixed(1)}L</div><div style="font-size:11px;color:var(--muted);">Total Earnings</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">₹${(mc/100000).toFixed(1)}L</div><div style="font-size:11px;color:var(--muted);">This Month</div></div><div style="background:#0d0d0d;border:1px solid rgba(232,224,208,0.07);border-radius:10px;padding:14px;text-align:center;"><div style="font-size:20px;font-weight:800;color:#E8E0D0;">${md.length}</div><div style="font-size:11px;color:var(--muted);">Deals This Month</div></div>`;if(target>0){const pct=Math.min((mc/target)*100,100);document.getElementById('targetProgress').innerHTML=`<div style="font-size:12px;color:var(--muted);margin-bottom:6px;">${mc.toLocaleString('en-IN')} / ₹${target.toLocaleString('en-IN')}</div><div style="height:8px;background:var(--border);border-radius:100px;overflow:hidden;"><div style="height:100%;width:${pct}%;background:${pct>=100?'#10B981':'#E8E0D0'};border-radius:100px;"></div></div><div style="font-size:12px;font-weight:700;color:${pct>=100?'#10B981':'#E8E0D0'};margin-top:6px;">${pct.toFixed(0)}% of target</div>`;}document.getElementById('dealsList').innerHTML=deals.length?deals.slice().reverse().map(d=>`<div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid rgba(232,224,208,0.07);"><div style="flex:1;"><div style="font-size:13px;font-weight:600;">${d.client}</div><div style="font-size:11px;color:var(--muted);">${d.property} · ${new Date(d.date).toLocaleDateString('en-IN',{day:'numeric',month:'short',year:'numeric'})}</div></div><div style="text-align:right;"><div style="font-size:13px;font-weight:700;color:#10B981;">+₹${d.commission.toLocaleString('en-IN')}</div><div style="font-size:10px;color:var(--muted);">${d.commPct}% of ${d.amount}</div></div><button onclick="deals=deals.filter(x=>x.id!=='${d.id}');localStorage.setItem('eb_deals',JSON.stringify(deals));renderRevenue();" style="background:none;border:none;color:#EF4444;cursor:pointer;font-size:13px;">🗑</button></div>`).join(''):'<div style="color:var(--muted);text-align:center;padding:20px;font-size:13px;">No deals yet — Add one!</div>';}
...
function showSubBanner(broker) {
  ...
  if (broker.status === 'trial' && broker.trial_start) {
    ...
    trialEnd.setDate(trialEnd.getDate() + (broker.trial_days || 7));
    const daysLeft = Math.max(0, Math.ceil((trialEnd - new Date()) / (1000 * 60 * 60 * 24)));
    const daysUsed = (broker.trial_days || 7) - daysLeft;
    statusEl.textContent = '🕐 Free Trial';
    statusEl.style.color = '#F0B84B';
    daysEl.textContent = daysUsed + ' din se chal raha · ' + daysLeft + ' din baaki';
    btn.style.display = 'block';
    btn.textContent = 'Subscribe Now →';
  } else if (broker.status === 'active') {
    let info = 'Active plan';
    if (broker.subscription_start && broker.subscription_valid_till) {
      const daysUsed = Math.floor((new Date() - new Date(broker.subscription_start)) / (1000*60*60*24));
      const daysLeft = Math.max(0, Math.ceil((new Date(broker.subscription_valid_till) - new Date()) / (1000*60*60*24)));
      info = daysUsed + ' din se chal raha · ' + daysLeft + ' din baaki';
    }
    statusEl.textContent = '✅ Active';
    statusEl.style.color = '#10B981';
    daysEl.textContent = info;
    btn.style.display = 'none';
  } else if (broker.status === 'expired') {
    statusEl.textContent = '❌ Expired';
    statusEl.style.color = '#EF4444';
    daysEl.textContent = 'Your plan has expired';
    btn.style.display = 'block';
    btn.textContent = 'Renew Now →';
  } else {
    statusEl.textContent = '⏳ Inactive';
    statusEl.style.color = '#F59E0B';
    daysEl.textContent = 'Bot active nahi';
    btn.style.display = 'block';
    btn.textContent = 'Subscribe Now →';
  }
}
